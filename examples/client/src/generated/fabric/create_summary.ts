  ...
  client
    ...
    .assistant((m) =>
      m
        ...
        .push("\n\n## MAIN POINTS:\n\n1. ")
        .gen("mp1", { maxTokens: 100, stop: ["\n"] })
        .push("\n2. ")
        .gen("mp2", { maxTokens: 100, stop: ["\n"] })
        .push("\n3. ")
        .gen("mp3", { maxTokens: 100, stop: ["\n"] })
        .push("\n4. ")
        .gen("mp4", { maxTokens: 100, stop: ["\n"] })
        .push("\n5. ")
        .gen("mp5", { maxTokens: 100, stop: ["\n"] })
        .push("\n6. ")
        .gen("mp6", { maxTokens: 100, stop: ["\n"] })
        .push("\n7. ")
        .gen("mp7", { maxTokens: 100, stop: ["\n"] })
        .push("\n8. ")
        .gen("mp8", { maxTokens: 100, stop: ["\n"] })
        .push("\n9. ")
        .gen("mp9", { maxTokens: 100, stop: ["\n"] })
        .push("\n10. ")
        .gen("mp10", { maxTokens: 100, stop: ["\n"] })
        .push("\n\n## TAKEAWAYS:\n\n1. ")
        .gen("take1", { maxTokens: 100, stop: ["\n"] })
        .push("\n2. ")
        .gen("take2", { maxTokens: 100, stop: ["\n"] })
        .push("\n3. ")
        .gen("take3", { maxTokens: 100, stop: ["\n"] })
        .push("\n4. ")
        .gen("take4", { maxTokens: 100, stop: ["\n"] })
        .push("\n5. ")
        .gen("take5", { maxTokens: 100, stop: ["\n"] })
        .push(""),
    );
